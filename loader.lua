...
if is_solara then
    if game.GameId ~= 1008451066 then
        game:GetService("Players").LocalPlayer:Kick("juju.lol > Solara only supports the Da Hood script!")
        return 
    end

    getgenv().script_key = script_key
    
    loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/4749f2f291e3f60f34f3c8f1ef7ef33e.lua"))()
    return
end
